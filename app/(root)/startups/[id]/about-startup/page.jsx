    ...
    return (
        <div className="bg-transparent text-white pl-4 rounded-lg shadow-md w-full mx-auto">
            ...
            <form onSubmit={handleSubmit} className="space-y-12 mt-10">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="flex flex-wrap gap-4 flex-col sm:flex-row">
                            <div className="flex-1">
                                ...
                                <Textarea id="pastInvestments" rows="4" className="bg-black mt-2 resize-none" value={financialDetails.pastInvestments} onChange={(e) => handleChange(e, setFinancialDetails)} placeholder="mention notable VCs or Angels"></Textarea>
                            </div>
                            <div className="flex-1">
                ...
                <Button type="submit" className="mt-8 button-primary hover:bg-blue-600">Save</Button>
            </form>
